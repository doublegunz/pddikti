...
<!-- start: Form Ubah Password -->
	...
	<p>Silakan masukan password baru untuk mengganti password dari user dengan NPM <?php echo $data_mahasiswa['npm']; ?>.</p>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="myform">
	<?php echo form_open('admin_controller/ubah_password'); ?>
	<!-- start: Ubah Password -->
	<tr>
	    <td>
