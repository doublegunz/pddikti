<div class="konten">
	<div align="right">
		...
		<a href="<?php echo base_url(); ?>index.php/admin_controller/tambah_data" class="tambah btn">Tambah Data</a>
		<a href="<?php echo base_url(); ?>index.php/admin_controller/tampil_mahasiswa" class="tambah btn">Daftar Mahasiswa</a>
		</form>
    </div>
<!-- start: Form Mahasiswa -->
	<h1>Form Mahasiswa</h1>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="myform">
	<?php echo form_open('admin_controller/tambah_data'); ?>
	<tr>
	    <td><label for="npm">NPM</label>
	    <input name="npm" type="text"  value="<?php echo set_value('npm'); ?>" size="70" autofocus placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('npm'); ?>
		</td>
		<td><label for="nama_mahasiswa">Nama Mahasiswa</label>
	    <input name="nama_mahasiswa" type="text"   value="<?php echo set_value('nama_mahasiswa'); ?>"  size="70" placeholder="Bagian ini wajib anda isi.">
	...
	<tr>
	    ...
	    <input name="nomor_ktp" type="text"   value="<?php echo set_value('nomor_ktp'); ?>" size="70" placeholder="Bagian ini wajib anda isi.">
	...
	<tr>
		...
		<input name="kode_pos" type="text"   value="<?php echo set_value('kode_pos'); ?>" size="70">
	...
	<tr>
		...
		<input name="email" type="email"   value="<?php echo set_value('email'); ?>" size="70" placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('email'); ?>
		</td>
	</tr>
	<tr>
		<td><label for="nama_penerima_kps">Penerima KPS</label>
		<input name="nama_penerima_kps" type="text"   value="<?php echo set_value('nama_penerima_kps'); ?>" size="70">
		<?php echo form_error('nama_penerima_kps'); ?>
		</td>
	    <td><label for="nomor_penerima_kps">No KPS</label>
		<input name="nomor_penerima_kps" type="text"   value="<?php echo set_value('nomor_penerima_kps'); ?>" size="70">
