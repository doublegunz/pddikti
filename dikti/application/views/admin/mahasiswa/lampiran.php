	...
	<tr>
		...
		<?php if($data_foto == NULL)
			...
			else
			{
				...
				<?php echo form_open_multipart('admin_controller/edit_foto_mahasiswa'); ?>
				<input type="file" name="foto" required> <br>&nbsp;Tipe file jpg<br>
		...
		<?php if($data_kk == NULL)
			{
				...
				<?php echo form_open_multipart('admin_controller/unggah_kk'); ?>
				<input type="file" name="foto" required> <br>&nbsp;Tipe file jpg<br>
				<input name="npm" type="hidden"  value="<?php echo $data_mahasiswa['npm']; ?>" size="70" ><br>
				<input type="submit" name="submit" id="submit" value="Unggah Foto">
				 <?php echo form_close(); 
			...
			else
			{
				...
				<?php echo form_open_multipart('admin_controller/edit_kk'); ?>
				<input type="file" name="foto" required> <br>&nbsp;Tipe file jpg<br>
				<input name="npm" type="hidden"  value="<?php echo $data_mahasiswa['npm']; ?>" size="70" ><br>
				<input type="submit" name="submit" id="submit" value="Edit Foto">
				 <?php echo form_close(); 
		...
		<?php if($data_ktp == NULL)
			{
				?><img src="<?php echo base_url(); ?>assets/scan/default/scan_kartu.jpg" width="160" height="160"><br>
				<?php echo form_open_multipart('admin_controller/unggah_ktp'); ?>
				<input type="file" name="foto" required> <br>&nbsp;Tipe file jpg<br>
				<input name="npm" type="hidden"  value="<?php echo $data_mahasiswa['npm']; ?>" size="70" ><br>
				<input type="submit" name="submit" id="submit" value="Unggah Foto">
				 <?php echo form_close(); 
			...
			else
			{
				...
				<?php echo form_open_multipart('admin_controller/edit_ktp'); ?>
				<input type="file" name="foto" required> <br>&nbsp;Tipe file jpg<br>
				<input name="npm" type="hidden"  value="<?php echo $data_mahasiswa['npm']; ?>" size="70" ><br>
		...
		<?php if($data_ktm == NULL)
			{
				?><img src="<?php echo base_url(); ?>assets/scan/default/scan_kartu.jpg" width="160" height="160"><br>
				<?php echo form_open_multipart('admin_controller/unggah_ktm'); ?>
				<input type="file" name="foto" required> <br>&nbsp;Tipe file jpg<br>
				<input name="npm" type="hidden"  value="<?php echo $data_mahasiswa['npm']; ?>" size="70" ><br>
			...
			else
			{
				...
				<?php echo form_open_multipart('admin_controller/edit_ktm'); ?>
				<input type="file" name="foto" required> <br>&nbsp;Tipe file jpg<br>
				<input name="npm" type="hidden"  value="<?php echo $data_mahasiswa['npm']; ?>" size="70" ><br>
				<input type="submit" name="submit" id="submit" value="Edit Foto"><br>
				 <?php echo form_close(); 
