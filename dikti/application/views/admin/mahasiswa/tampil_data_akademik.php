...
<!-- start: Data Akademik Mahasiswa -->
  ...
  <!-- end: Data Akademik Mahasiswa -->
	...
	<?php 
		...
		{ ?>
			<a href="<?php echo base_url(); ?>index.php/admin_controller/edit_data_akademik" class="tambah">Edit Data</a>
	<?php 
		}
		else
		{ ?> 
		<a href="<?php echo base_url(); ?>index.php/admin_controller/tambah_data_akademik" class="tambah">Isi Data Akademik</a> 
	<?php } ?>
