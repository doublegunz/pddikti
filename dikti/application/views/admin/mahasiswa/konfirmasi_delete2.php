<div class="konten">
	<div align="right">
	 ...
	 <!-- start: Konfirmasi Delete Data Ayah Mahasiswa -->
	<h1>Konfirmasi Delete Data Ayah Mahasiswa</h1>
	<div class="warning">
	<p>Anda yakin ingin menghapus data ayah dari mahasiswa dengan NPM <?php echo $npm; ?>?</p>
		<a href="<?php echo base_url(); ?>index.php/admin_controller/delete_data_ayah/<?php echo $npm; ?>" class="delete">YA</a>
		<a href="<?php echo base_url(); ?>index.php/admin_controller/tampil_orangtua_wali" class="tambah">TIDAK</a>
	</div>
</div>
<!-- end: Konfirmasi Delete Data Ayah Mahasiswa -->