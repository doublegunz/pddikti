...
<!-- start: Form Edit Data Ayah -->
	...
	<?php echo form_open('user_controller/tambah_data_ayah'); ?>
	<!-- start: Data Ayah -->
	<tr>
		<td><label for="nama_ayah">Nama Ayah</label>
	    <input name="nama_ayah" type="text"    value="<?php echo set_value('nama_ayah'); ?>"  size="70" autofocus>
	...
	<tr>
		...
		<input type="text" name="tanggal_lahir"    value="<?php echo set_value('tanggal_lahir'); ?>" size="40">
