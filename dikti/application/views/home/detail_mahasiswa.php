...
<!-- start: Data Mahasiswa -->
	...
	<tr>
		...
		<?php if($data_foto == NULL)
			{
				?><img src="<?php echo base_url(); ?>assets/scan/default/mahasiswa.jpg" width="160" height="160"><?php
			}
			else
			{
  ...
  <a href="<?php echo base_url(); ?>index.php/home/pencarian" class="tambah">Kembali </a>
  <!-- end: Data Mahasiswa -->
  </div>