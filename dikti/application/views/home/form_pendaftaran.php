...
<!-- start: Form Pendaftaran PDPT -->
	...
	<tr>
	    ...
	    <input name="npm" type="text"  value="<?php echo set_value('npm'); ?>" size="40" autofocus placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('npm'); ?>
		</td>
		<td><label for="nama_mahasiswa">Nama Mahasiswa</label>
	    <input name="nama_mahasiswa" type="text"   value="<?php echo set_value('nama_mahasiswa'); ?>"  size="40" placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('nama_mahasiswa'); ?>
		</td>
    </tr>
	<tr>
	    <td><label for="tempat_lahir">Tempat Lahir</label>
	    <input name="tempat_lahir" type="text"   value="<?php echo set_value('tempat_lahir'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
	...
	<tr>
	    ...
	    <input name="nomor_ktp" type="text"   value="<?php echo set_value('nomor_ktp'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('nomor_ktp'); ?>
		</td>
	</tr>
	<tr>
		<td><label for="alamat_rumah">Alamat Rumah</label>
		<input name="alamat_rumah" type="text"   value="<?php echo set_value('alamat_rumah'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('alamat_rumah'); ?>
		</td>
    </tr>
	<tr>
	   <td><label for="alamat_desa">Desa</label>
	   <input name="alamat_desa" type="text"   value="<?php echo set_value('alamat_desa'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('alamat_desa'); ?>
		</td>
	    <td><label for="alamat_kelurahan">Kelurahan</label>
		<input name="alamat_kelurahan" type="text"   value="<?php echo set_value('alamat_kelurahan'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
	...
	<tr>
		...
		<input name="alamat_kecamatan" type="text"   value="<?php echo set_value('alamat_kecamatan'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('alamat_kecamatan'); ?>
		</td>
    </tr>
	<tr>
		<td><label for="alamat_kabupaten">Kota / Kabupaten</label>
		<input name="alamat_kabupaten" type="text"   value="<?php echo set_value('alamat_kabupaten'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
	...
	<tr>
		...
		<input name="telepon_rumah" type="text"   value="<?php echo set_value('telepon_rumah'); ?>" size="40">
	...
	<tr>
		...
		<input name="email" type="text"   value="<?php echo set_value('email'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
	...
	<tr>
		...
		<input name="password" type="password"   value="<?php echo set_value('password'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
		<?php echo form_error('password'); ?>
		</td>
	    <td><label for="passconf">Konfirmasi Password</label>
		<input name="passconf" type="password"   value="<?php echo set_value('passconf'); ?>" size="40" placeholder="Bagian ini wajib anda isi.">
