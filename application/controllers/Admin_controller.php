...
class Admin_controller extends CI_Controller
{
    ...
    public function print_daftar_mahasiswa()
    {
        $jumlah= $this->pdpt_model->jumlah_mahasiswa();
    ...
    {
		$this->set_create_validation();
        
        if ($this->form_validation->run() === false) {
            $data = [
				'title' => 'Manajemen Data Mahasiswa - Pangkalan Data Pendidikan Tinggi',
            ...
            redirect(site_url('admin_controller/tampil_mahasiswa'));
        }
    }
	...
	private function set_create_validation()
	{
    ...
    public function edit_data_mahasiswa($npm)
    {
    ...
    public function konfirmasi_delete($npm)
    {
    ...
    public function delete_data_mahasiswa($npm)
    {
    ...
    public function print_data($npm)
    {
        $this->session->set_userdata('npm', $npm);
    ...
    public function tampil_orangtua_wali()
    {
        $jumlah= $this->pdpt_model->jumlah_mahasiswa();
    ...
    public function orangtua_wali_tampil($npm)
    {
        $this->session->set_userdata('npm', $npm);
        redirect(base_url().'index.php/admin_controller/orangtua_mahasiswa');
    }
    
    public function orangtua_wali_edit($npm)
    {
        $this->session->set_userdata('npm', $npm);
        redirect(base_url().'index.php/admin_controller/edit_data_orangtua');
    }
    
    public function konfirmasi_delete2($npm)
    {
    ...
    public function delete_data_ayah($npm)
    {
        $this->pdpt_model->delete_data_ayah($npm);
        redirect(base_url().'index.php/admin_controller/tampil_orangtua_wali');
    }
    
    public function konfirmasi_delete3($npm)
    {
        $data=array('title'=>'Konfirmasi Delete Data Ayah Mahasiswa - Pangkalan Data Pendidikan Tinggi',
                            'npm'  =>$npm,
    ...
    public function delete_data_ibu($npm)
    {
        $this->pdpt_model->delete_data_ibu($npm);
        redirect(base_url().'index.php/admin_controller/tampil_orangtua_wali');
    }
    
    public function orangtua_wali_tampil2($npm)
    {
        $this->session->set_userdata('npm', $npm);
        redirect(base_url().'index.php/admin_controller/wali_mahasiswa');
    }
    
    public function orangtua_wali_edit2($npm)
    {
        $this->session->set_userdata('npm', $npm);
        redirect(base_url().'index.php/admin_controller/edit_data_wali');
    }
    
    public function konfirmasi_delete4($npm)
    {
        $data=array('title'=>'Konfirmasi Delete Data Ayah Mahasiswa - Pangkalan Data Pendidikan Tinggi',
                            'npm'  =>$npm,
    ...
    public function delete_data_wali($npm)
    {
        $this->pdpt_model->delete_data_wali($npm);
        redirect(base_url().'index.php/admin_controller/tampil_orangtua_wali');
    }
    
    public function tampil_akademik_lampiran()
    {
        $jumlah= $this->pdpt_model->jumlah_mahasiswa();
    ...
    public function delete_lampiran($npm)
    {
        $this->pdpt_model->delete_data_kk($npm);
        $this->pdpt_model->delete_data_ktp($npm);
        $this->pdpt_model->delete_data_ktm($npm);
    ...
    public function konfirmasi_delete7($npm)
    {
        $data=array('title'=>'Konfirmasi Delete Data Mahasiswa - Pangkalan Data Pendidikan Tinggi',
                            'npm'  =>$npm,
    ...
    public function delete_data_user($npm)
    {
        $this->pdpt_model->delete_data_mahasiswa($npm);
        $this->pdpt_model->delete_data_ayah($npm);
        $this->pdpt_model->delete_data_ibu($npm);
