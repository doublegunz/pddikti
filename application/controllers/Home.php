...
class Home extends CI_Controller {
	...
	public function pendaftaran() 
	{
		...
		{
			$data=array('title'=>'Pendaftaran PDPT - Pangkalan Data Pendidikan Tinggi',
		...
		{	
			...
			$this->pdpt_model->add_mahasiswa($data_mahasiswa);
			$this->pdpt_model->add_user($data_user);
			$this->pdpt_model->hak_akses($data_akses);
			
			$data=array('title'		=>'Pendaftaran Berhasil - Pangkalan Data Pendidikan Tinggi',
