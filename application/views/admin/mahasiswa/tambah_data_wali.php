...
<!-- start: Form Wali -->
	...
	<?php echo form_open('admin_controller/tambah_data_wali'); ?>
	<!-- start: Data Wali -->
	<tr>
	...
	<tr>
		...
		<input type="text" name="tanggal_lahir"  placeholder="Contoh penulisan: 1992-02-29"  value="<?php echo set_value('tanggal_lahir'); ?>" size="70">
