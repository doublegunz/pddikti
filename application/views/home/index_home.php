...
<div class="konten">
	<div class="posting">
		...
		<?php foreach ($berita as $list) { ?>
			<div class="ringkasan">
				<h3>
					<a href="<?php echo site_url('home/read/' . $list['slug']) ?>">
						<?php echo $list['judul']; ?>
					</a>
				</h3>
				...
				<br>
				<p align=right>
					<a href="<?php echo site_url('home/read/'. $list['slug']); ?>">&nbsp;Read more</a></b>
				</p><br>
			</div>
		<?php }
	...
	<div class="anggota">
		...
		<p>
			<a href="<?php echo site_url('login'); ?>" class="tambah">Login</a>
			<a href="<?php echo site_url('register'); ?>" class="tambah">Daftar</a>
		</p>
	</div>
