...
<form name="form1" method="POST" action="<?php echo base_url();?>index.php/login/cek_data">
  ...
  <p>
    <input type="submit" name="submit" id="submit" value="Submit">
	 <p><a href="<?php echo base_url(); ?>index.php/login">Login</a> | <a href="<?php echo base_url(); ?>index.php/home/pendaftaran">Daftar PDPT</a></p>
