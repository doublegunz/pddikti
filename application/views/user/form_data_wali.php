...
<?php 
	if($data_wali == NULL)
	{
		redirect(base_url().'index.php/user_controller/tambah_data_wali');
	}
	else
	{?>
	...
	<!-- start: Form Edit Data Wali -->
		...
		<?php echo form_open('user_controller/edit_data_wali'); ?>
		<!-- start: Data Wali -->
		<tr>
		...
		<tr>
			...
			<input type="text" name="tanggal_lahir" placeholder="Contoh penulisan: 1992-02-29" value="<?php echo $data_wali['tanggal_lahir']; ?>" size="40">
		...
		<tr>
			...
			<input name="kode_pos" type="text" value="<?php echo $data_wali['kode_pos']; ?>" size="40">
		...
		<tr>
			...
			<input name="telepon_genggam" type="text" value="<?php echo $data_wali['telepon_genggam']; ?>" size="40">
